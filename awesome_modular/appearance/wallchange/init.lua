...
--
local wall_dir = filesystem.get_configuration_dir() .. "appearance/wallchange/wallpapers/" .. chosen_theme .."/"
...
local update_current_wall = function(wallname)
  ...
  gears.timer {
    ...
    callback  = function()
      ...
      --gears.wallpaper.fit (wall_dir .. wallname, s)
    end,
    single_shot = true
  }
...
--  gears.wallpaper.fit(wall_dir .. wall_data[2], s)
