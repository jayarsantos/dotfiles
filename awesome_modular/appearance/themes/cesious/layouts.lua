local layout_path = icon_dir .. chosen_theme .. "/layouts/"
local default_path = icon_dir .. "default/layouts/"
...
--others
theme.layout_cornernw  		= default_path .. "cornernw.png"
theme.layout_cornerne       	= default_path .. "cornerne.png"
theme.layout_cornersw       	= default_path .. "cornersw.png"
theme.layout_cornerse       	= default_path .. "cornerse.png"
