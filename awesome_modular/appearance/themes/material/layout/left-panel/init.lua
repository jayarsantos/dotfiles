    ...
    _G.awesome.spawn(
      ...
      function()
        panel:toggle()
          ...
          ----commented lines excludes rofi in opening panel
...
--    end
  ...
  panel:setup {
    ...
    nil,
    {
      ...
      {
        require('skins.material.layout.left-panel.dashboard')(screen, panel),
        layout = wibox.layout.stack
      }
    },
    require('skins.material.layout.left-panel.action-bar')(screen, panel, action_bar_width)
  }
  return panel
end
