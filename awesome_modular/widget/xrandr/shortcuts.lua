local shortcuts = {
  _NAME = "widget.foggy.shortcuts"
}

local set_backlight = require('widget.xrandr.xrandr').actions.set_backlight
local get_output = require('widget.xrandr.menu').get_output
